...
class Funcoes{
	...
	void config_glut(){
			...
			glutCreateWindow("Atividade 10.1"); // Create a window with the given title
			...
			float luz_ambiente[4]={0,0,0,1};
			float luz_difusa[4]={1,1,1,1};
			float luz_especular[4]={1, 1, 1, 1};
			float posicao_luz[4]={45, -1000, -1000, -1000};
			float direcao_spot[3]={1, 1, -1};
			float angulo_corte[1] = {180};
			...
			glLightfv(GL_LIGHT0, GL_SPOT_DIRECTION, direcao_spot );
			glLightfv(GL_LIGHT0, GL_SPOT_CUTOFF, angulo_corte );
	}
